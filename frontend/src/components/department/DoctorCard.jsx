...
export default function DoctorCard({ doctor }) {
  const doctorImage =
    ...
    (doctor.gender === "female"
      ? "/src/assets/doctors/default-female.svg"
      : "/src/assets/doctors/default-male.svg");
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              <button className="bg-[#243B8F] hover:bg-blue-900 text-white px-5 py-2 rounded-lg transition">
                Appointment
              </button>
