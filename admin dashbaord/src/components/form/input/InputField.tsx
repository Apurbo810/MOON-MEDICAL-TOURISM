...
const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    let inputClasses = `h-11 w-full rounded-lg border appearance-none bg-white px-4 py-2.5 text-sm shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-3 dark:bg-gray-900/80 dark:text-white/90 dark:placeholder:text-white/30 ${className}`;
